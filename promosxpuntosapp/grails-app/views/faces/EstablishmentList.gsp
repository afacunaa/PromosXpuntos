...
<head>
    ...
    <g:set var="entityName" value="${message(code: 'person.label', default: 'Establishment')}" />
...
<div id="list-Establishment" class="content scaffold-list" role="main">
    ...
    <table>
        ...
        <tr>
            ...
            <g:sortableColumn property="address" title="${message(code: 'person.ID.label', default: 'Address')}" />

            <g:sortableColumn property="telephoneNumber" title="${message(code: 'person.telephone.label', default: 'telephoneNumber')}" />
