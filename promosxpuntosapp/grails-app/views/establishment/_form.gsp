...
<div class="fieldcontain ${hasErrors(bean: establishmentInstance, field: 'customer', 'error')} required">
	...
	<g:select id="customer" name="customer.id" from="${promosxpuntosapp.Customer.list()}" optionKey="id" required="" value="${establishmentInstance?.customer?.id}" class="many-to-one"/>
